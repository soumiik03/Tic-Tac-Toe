    ...
    <div className="relative min-h-screen w-full flex flex-col items-center justify-center overflow-hidden bg-black">
      ...
      <div className="relative z-10 flex flex-col items-center gap-7">
        ...
        <div className="text-center animate-fade-in-up">
          <h1 className="text-8xl font-black tracking-tight text-white mb-1" style={{ fontFamily: '"Segoe UI", "Helvetica Neue", sans-serif', letterSpacing: '-0.03em' }}>
            TicTacToe
          </h1>
          <p className="text-sm tracking-[0.2em] uppercase text-white/70 font-bold">
            Two Player Game
          </p>
        </div>
        ...
        {/* Status */}
        <GameStatus winnerResult={winnerResult} draw={draw} isXTurn={isXTurn} />
